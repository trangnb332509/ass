 ...
 * @author Dell Inc
 */
public class UpdatePrintedController extends BaseRequiredAuthenticationController {
    ...
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintedGoods pg = pgdao.getPrintedGood(id, date);
        
        request.setAttribute("patterns", patterns);
        request.setAttribute("id", id);
        request.setAttribute("pg", pg);
        request.getRequestDispatcher("updatePrinted.jsp").forward(request, response);
    }
