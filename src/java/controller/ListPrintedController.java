 ...
 * @author Dell Inc
 */
public class ListPrintedController extends BaseRequiredAuthenticationController {
    ...
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<PrintedGoods> pgs = pgdao.getById(id, pageindex, pagesize);
        EmployeeDAO e = new EmployeeDAO();
        Employee ee = e.getEmployeeById(id);
        request.setAttribute("ee", ee);
        
        int total_records = pgdao.count(id);
        ...
        request.getRequestDispatcher("listPrinted.jsp").forward(request, response);
    }
