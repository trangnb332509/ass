 ...
 * @author Dell Inc
 */
public class UpdateTailorController extends BaseRequiredAuthenticationController {
    ...
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        TailorGoods tg = tgdao.getTailorGoods(id, date);
        
        request.setAttribute("id", id);
        request.setAttribute("categories", categories);
        request.setAttribute("tg", tg);
        request.getRequestDispatcher("updateTailor.jsp").forward(request, response);
