 ...
 * @author Dell Inc
 */
public class ListButtonHoleController extends BaseRequiredAuthenticationController {
    ...
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ButtonHoleGoodsDAO bgdao = new ButtonHoleGoodsDAO();
        ArrayList<ButtonholeGoods> bgs = bgdao.getById(id, pageindex, pagesize);
        EmployeeDAO e = new EmployeeDAO();
        Employee ee = e.getEmployeeById(id);
        request.setAttribute("ee", ee);
        int total_records = bgdao.count(id);
        ...
        request.getRequestDispatcher("listButtonHole.jsp").forward(request, response);
    }
