 ...
 * @author Dell Inc
 */
public class InsertButtonHoleController extends BaseRequiredAuthenticationController {
    ...
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("insertButtonHole.jsp").forward(request, response);
    }
